  ...
  const renderError = () => {
    ...
    return (
      <div className="flex flex-col items-center justify-center text-center p-6 h-full animate-in fade-in zoom-in duration-300">
        ...
        <h2 className="text-2xl font-bold text-red-700 uppercase tracking-wide mb-2">
          {title}
        </h2>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="bg-white p-3 rounded-xl border border-gray-100 shadow-sm flex flex-col">
              ...
              <span className="text-gray-600 font-semibold">
                {formatMoney(successMessage.old_balance)}
              </span>
            </div>
            <div className="bg-white p-3 rounded-xl border border-red-100 shadow-sm flex flex-col relative overflow-hidden">
              ...
              <span className="text-xs text-red-500 uppercase font-bold z-10">
                Saldo Atual
              </span>
              <span className="text-green-600 font-bold text-lg z-10">
                {formatMoney(successMessage.balance)}
              </span>
            </div>
          </div>
